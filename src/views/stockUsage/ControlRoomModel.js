...
const ControlRoomModel = ({ visible, onClose, onControlRoomAdded }) => {
    ...
    pincode: '',
      ...
      const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axiosInstance.post('/controlRooms', formData);
            if (onControlRoomAdded) {
                onControlRoomAdded(res.data.data);
              }
            onClose();
        } catch (error) {
  ...
  return (
    <CModal visible={visible} onClose={onClose} size="lg">
      <CModalHeader closeButton>
        <CModalTitle>Add Control Room</CModalTitle>
      </CModalHeader>
      <CModalBody>
      {apiError && (
...
ControlRoomModel.propTypes = {
  visible: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  onControlRoomAdded: PropTypes.func,
};

export default ControlRoomModel;
