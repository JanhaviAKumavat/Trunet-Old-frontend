...
const ProductCategoryList = () => {
  ...
  return (
    <div>
      <div className='title'>Product Category List </div>
            ...
            <CTableHead>
              <CTableRow>
                <CTableHeaderCell scope="col" onClick={() => handleSort('partnerName')} className="sortable-header">
                  Product Category {getSortIcon('partnerName')}
                </CTableHeaderCell>
                <CTableHeaderCell scope="col" onClick={() => handleSort('centerName')} className="sortable-header">
                 Product Category Remark {getSortIcon('centerName')}
                </CTableHeaderCell>
              ...
              {filteredCategories.length > 0 ? (
                filteredCategories.map((category) => (
                  <CTableRow key={category._id}>
                    <CTableDataCell>{category.productCategory}</CTableDataCell>
                    <CTableDataCell>{category.remark}</CTableDataCell>
                    <CTableDataCell>
